...
import { AlertCircle, Clock, QrCode, ShieldCheck } from 'lucide-react';
          ...
          <div className='p-12 text-center animate-in zoom-in-95 duration-500'>
            {error ? (
              <>
                ...
                <h3
                  className={`text-2xl font-bold mb-4 ${error.includes('OTRO DÍA') ? 'text-yellow-500' : 'text-red-500'}`}
                >
                  {error}
                </h3>
                <button
              ...
              <>
                ...
                <div className='text-neon-cyan font-bold text-xl mb-6'>
                ...
                <div className='bg-white/5 rounded-2xl p-6 text-left space-y-2 mb-8 border border-white/10'>
                  ...
                  <p className='font-bold'>
                    {appointment.appointment_date} @ {appointment.appointment_time} HS
                  </p>
                </div>
